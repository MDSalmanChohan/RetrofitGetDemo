    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGetData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Methods methods = RetrofitInstance.getRetrofitInstance().create(Methods.class);
...
//             i dont want device id in this project if you dont have any idea for me so please tell me how  are you in your family function for this demo
            }
        });
    }
}